...
음원 읽기와 푸리에 변환에는 파이썬의 librosa 패키지를 사용했으며 시간에 따라 20개 주파수 대역별로 세기를 나타낸 MFCC 벡터를 생성했다.
...
| 50M |1.323e-02|  3.048  |  0.0679 |  13.23  |
| 50F |2.547e-04|  1.724  |  0.0550 |  6.517  |

- - 각 열을 각 열의 합으로 나눈다. jitter를 기준으로 이 샘플 데이터는 30대 남성일 확률이 21.7%로 가장 높다.
...
| 50M |2.751e-01|  0.1689 |  0.1462 |  0.1372 |
| 50F |5.295e-03|  0.0955 |  0.1183 |  0.0676 |
| SUM |       1 |       1 |       1 |       1 |

- - 각 열을 모두 더하고 특성의 수로 나눠 각 카테고리에 속할 확률을 구한다.
...
참고문헌
--------------
[1] 서윤정, 신지영. (2018). 모음 연장 발성이 보이는 연령대별 음향음성학적 특성 연구. 말소리와 음성과학, 10(4), pp. 67-76.
